...
| `GET` | `/api/engines` | Effective graph backend + retrieval engine (v0.9.4) |
...
**Settings UI** (Galaxy monitor): Graph Backend (Native / Auto / CBM) and Retrieval Engine presets; **Probe CBM connection** uses the probe endpoint above.
