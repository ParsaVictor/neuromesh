...
window.NMI18n = (function () {
  ...
  const dict = {
    en: {
      ...
      'hero.badgeRelease': 'v0.9.7 — zero-embed fast engine · instant index',
      ...
      'galaxy.c1': 'Bird\'s-eye view of packages and modules',
      ...
      'stats.sub': 'v0.9.7 · default fast engine · up to ~97% fewer tokens vs attaching the whole project',
      ...
      'stats.th.task': 'Task',
      'stats.th.repo': 'Full repo',
      'stats.th.before': 'Before fold',
      'stats.th.packet': 'Packet',
      'stats.th.saved': 'Saved',
      'stats.task1': 'Fix MCP tool handler',
      'stats.task2': 'Trace graph routing',

      'engines.label': 'Defaults',
      'engines.title': 'Fast by default. Embeddings opt-in.',
      'engines.lead': 'v0.9.7 ships with <strong>engine: fast</strong> — instant graph index, no ONNX warm. Install, index, pass your prompt — done. Opt in to <strong>hybrid</strong> / <strong>deep</strong> when you need semantic search.',
      ...
      'engines.seedDesc': 'One command registers MCP and copies agent rules so your IDE actually uses NeuroMesh instead of raw file reads.',
      'engines.docsLink': 'Full setup guide →',

      'install.label': 'Get started',
      'install.title': 'Install in one command',
      'install.lead': 'Pre-built binary for macOS, Linux, and Windows — <strong>no Rust required</strong>. ~50 MB download, no model bundled. Then <code>neuromesh doctor</code> and <code>neuromesh connect --global --agent-rules</code>.',
      ...
      'docs.d5.s': 'Run eval on your own repo',
      'docs.d7.t': 'Configuration',
      'docs.d7.s': 'Engines, connect, monitor port',
    ...
    fa: {
      ...
      'hero.badgeRelease': 'نسخه 0.9.7 — موتور fast بدون embed · index فوری',
      ...
      'galaxy.c1': 'نمای کلی package و ماژول',
      ...
      'stats.sub': 'نسخه 0.9.7 · engine fast پیش‌فرض · تا ~۹۷٪ توکن کمتر نسبت به attach کل پروژه',
      ...
      'stats.th.task': 'Task',
      'stats.th.repo': 'کل repo',
      'stats.th.before': 'قبل fold',
      'stats.th.packet': 'بسته',
      'stats.th.saved': 'صرفه‌جویی',
      'stats.task1': 'Fix handler ابزار MCP',
      'stats.task2': 'Trace مسیریابی گراف',

      'engines.label': 'پیش‌فرض',
      'engines.title': 'پیش‌فرض fast. embed اختیاری.',
      'engines.lead': 'نسخه 0.9.7 با <strong>engine: fast</strong> می‌آید — index گراف فوری، بدون ONNX. نصب، index، prompt — تمام. برای جستجوی معنایی <strong>hybrid</strong> / <strong>deep</strong> را فعال کنید.',
      ...
      'engines.seedDesc': 'یک دستور MCP را ثبت می‌کند و rule agent را کپی می‌کند تا IDE واقعاً از NeuroMesh استفاده کند — نه Read/Grep خام.',
      'engines.docsLink': 'راهنمای کامل تنظیمات →',

      'install.label': 'شروع کن',
      'install.title': 'نصب با یک دستور',
      'install.lead': 'باینری آماده برای macOS، Linux و Windows — <strong>بدون Rust</strong>. دانلود ~۵۰ MB، بدون مدل باندل. بعد <code>neuromesh doctor</code> و <code>neuromesh connect --global --agent-rules</code>.',
      ...
      'docs.d5.t': 'benchmark',
      'docs.d5.s': 'eval را روی repo خودتان اجرا کنید',
      'docs.d7.t': 'تنظیمات',
      'docs.d7.s': 'engine، connect، پورت monitor',
      'docs.d6.t': 'مشارکت',
  ...
  const pipelineSteps = {
    en: [
      { icon: '💬', title: 'Your prompt', phase: 'read', key: 'pipe.0',
        desc: 'Describe the task in plain language — English, Persian, Arabic, anything. No keyword tables to maintain.' },
      { icon: '🔍', title: 'Find symbols', phase: 'read', key: 'pipe.1',
        desc: 'NeuroMesh expands your prompt server-side and matches symbols on the live graph. Hybrid/deep adds MiniLM when you opt in.' },
    ...
    fa: [
      { icon: '💬', title: 'prompt شما', phase: 'read', key: 'pipe.0',
        desc: 'task را به زبان خودتان بنویسید — فارسی، انگلیسی، عربی، هر چیزی. جدول keyword لازم نیست.' },
      { icon: '🔍', title: 'symbol پیدا کن', phase: 'read', key: 'pipe.1',
        desc: 'NeuroMesh prompt را سمت سرور گسترش می‌دهد و symbol را روی گراف زنده match می‌کند. hybrid/deep MiniLM اضافه می‌کند.' },
  ...
  const pipeNodeKeys = {
    en: [
      { title: 'Your prompt', key: 'Any language' },
      { title: 'Find symbols', key: 'Graph + expansion' },
    ...
    fa: [
      { title: 'prompt شما', key: 'هر زبانی' },
      { title: 'symbol پیدا کن', key: 'گراف + گسترش' },
